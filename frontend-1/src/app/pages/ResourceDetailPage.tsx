...
export default function ResourceDetailPage() {
  ...
  const article = {
    ...
    content: `
      ...
      <h3>Step 6: Catalogue Creation</h3>
      <p>Once verified, you can start creating your product/service catalogue. This is crucial for visibility and sales on the platform.</p>
      ...
      <ul>
        <li>Keep your catalogue updated regularly</li>
      ...
      <p>If you find the registration process overwhelming or want expert assistance, Phoenix Tender Tech offers comprehensive GeM registration services. Our team can handle the entire process for you, ensuring error-free registration and optimal catalogue setup.</p>

      <h2>Conclusion</h2>
      <p>GeM registration opens up immense opportunities for businesses to tap into the government procurement market. While the process might seem complex initially, following this guide will help you navigate it successfully. Remember, proper registration and catalogue management are key to your success on the platform.</p>
