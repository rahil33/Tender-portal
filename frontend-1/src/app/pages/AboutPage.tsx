...
export default function AboutPage() {
  ...
  const timeline = [
    { year: '2016', title: 'Company Founded', desc: 'Phoenix Tender Tech was established in Ahmedabad with a vision to simplify government procurement for businesses of all sizes.' },
    { year: '2018', title: 'GeM Expertise', desc: 'Became one of the first consultancies to specialise in Government e-Marketplace (GeM) services after its launch.' },
    { year: '2020', title: 'Digital Platform', desc: 'Launched online portal for real-time tender tracking and digital consultation services across India.' },
    { year: '2021', title: '1,000+ Clients', desc: 'Crossed the milestone of 1,000 businesses onboarded and registered on GeM with pan-India reach.' },
    { year: '2022', title: 'Industry Recognition', desc: '"Best Tender Consultancy" — Indian SME Association. ISO 9001:2015 certified.' },
    { year: '2024', title: 'Continued Growth', desc: 'Expanding nationwide with 2,000+ sellers registered and significant procurement value facilitated.' },
  ];
  ...
  const story = [
    'Serving businesses since 2016, Phoenix Tender Tech emerged from a simple vision: to democratise access to government procurement opportunities for businesses of all sizes. Our founders, with extensive experience in government contracting, recognised the challenges small and medium businesses faced in navigating the complex tender ecosystem.',
    'What started as a small consultancy helping local businesses with tender documentation has grown into a comprehensive platform serving clients across India. Today, we pride ourselves on being the bridge between ambitious businesses and lucrative government contracts.',
      ...
      <section className="py-24 bg-[#F8FAFC] border-y border-gray-100">
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12">
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900" style={{ fontFamily: 'Poppins, sans-serif' }}>Serving Businesses Since 2016</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <div className="space-y-7">
                {[
                  { icon: <MapPin size={18} />, label: 'Address', lines: ['A302, Swaminarayan Park 7', 'Vatva Narol Canal Road', 'Ahmedabad, Gujarat 382405'] },
                  { icon: <Phone size={18} />, label: 'Phone', lines: ['+91 96010 05549'] },
                  { icon: <Mail size={18} />, label: 'Email', lines: ['phoenixtendertech@gmail.com'] },
                ].map((c) => (
