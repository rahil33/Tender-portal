...
import {
  UploadCloud, FileText, Image, CheckCircle, ChevronDown,
  AlertCircle, ArrowLeft, ArrowRight, Package, IndianRupee, Info,
} from 'lucide-react';
import type { Step, UploadedFile } from '../components/tender-upload/types';
import { TENDER_CATEGORIES } from '../components/tender-upload/types';
import { StepIndicator } from '../components/tender-upload/StepIndicator';
import { DropZone } from '../components/tender-upload/DropZone';
import { SectionTitle, FormField, uploadFormStyles } from '../components/tender-upload/FormHelpers';
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <FormField label="Product / Item Code" hint="Internal SKU or catalogue code">
