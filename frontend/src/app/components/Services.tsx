...
const SERVICES = [
  {
    ...
    desc: 'Expert assistance with GeM desktop assessment documentation requirements and complete profile setup.'
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    slug: 'msme-udyam',
    desc: 'Udyam registration certificate with expert assistance for MSME benefits.'
  },
  {
    icon: Award,
    title: 'ZED Certificate',
    slug: 'zed-certificate',
    desc: 'ZED certification assistance including application support and guidance.'
  },
  {
    icon: Users,
    title: 'Consulting Services',
    slug: 'consulting-services',
    desc: 'Strategic consulting services for government procurement, tender compliance, and successful bid submissions.'
  }
];
...
export const Pricing: React.FC = () => {
  const plans = [
    ...
    },
    {
      ...
      price: 'Custom',
      period: 'per year',
      features: ['Dedicated Account Manager', 'MSME & ZED Certification', 'Legal Advisory for Bids', 'Joint Venture Matching', 'Priority Document Prep', 'Competitor Analysis'],
      cta: 'Contact Sales',
      popular: false
    }
  ];
