...
const SERVICES = [
  ...
  },
  {
    ...
    slug: 'application-for-assessment',
    desc: 'Comprehensive OEM assessment process including document preparation.',
    accent: '#10B981',
  },
  {
    icon: Zap,
    title: 'Documents Preparation for Desktop Assessment',
    slug: 'documents-preparation-for-desktop-assessment',
    desc: 'Expert assistance with GeM desktop assessment documentation requirements.',
    accent: '#059669',
  },
  {
    icon: GraduationCap,
    title: 'Guidance for Video Assessment',
    slug: 'guidance-for-video-assessment',
    desc: 'Training and preparation for GeM video assessment sessions.',
    accent: '#16A34A',
  },
  {
    icon: ShieldCheck,
    ...
    desc: 'Professional brand registration and identity establishment on GeM portal.',
    accent: '#16A34A',
  },
  {
    icon: Users,
    title: 'OEM Panel Activation',
    slug: 'oem-panel-activation',
    desc: 'Complete OEM panel activation and reseller management setup.',
    accent: '#0D9488',
  },
  {
    icon: Laptop,
  ...
  },
  {
    ...
    desc: 'ZED certification assistance including application support, documentation, assessment guidance, certification process, and consultation.',
    accent: '#D97706',
  },
];
