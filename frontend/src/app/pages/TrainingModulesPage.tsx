...
const modules: Module[] = [
  {
    ...
    lessons: 12,
    level: 'Beginner',
    description: 'Master professional product catalog creation on GeM — categorisation, specifications, image guidelines, and inventory management.',
    topics: [
      'How to create a product catalog on GeM',
  ...
  },
  {
    ...
    lessons: 18,
    level: 'Intermediate',
    description: 'Learn the complete tender bidding process — from reading tender documents to post-bid management with real examples.',
    topics: [
...
export default function TrainingModulesPage() {
  ...
  const included = [
    ...
    'WhatsApp training support channel',
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-gray-400 mb-6">
                <Zap size={13} /> WhatsApp Training
              </span>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
                Learn on WhatsApp — On Your Schedule
              </h2>
              <p className="text-gray-500 mb-6 leading-relaxed">
                Daily video lessons, PDF worksheets, interactive quizzes, and 1-on-1 instructor support — delivered directly to your WhatsApp.
              </p>
              ...
              <a href="https://wa.me/919876543210?text=I%20want%20to%20enroll%20for%20WhatsApp%20training"
                ...
                <MessageCircle size={16} /> Start WhatsApp Training
              </a>
            </div>
        ...
        <div className="bg-[#F8FAFC] rounded-2xl border border-gray-200 p-8 md:p-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400 mt-3">Limited seats available · Secure payment gateway</p>
          </div>
        </div>
      </div>
    </div>
