...
export default function AboutPage() {
  ...
  const timeline = [
    { year: '2014', title: 'Company Founded', desc: 'Phoenix Tender Tech was established in Ahmedabad with a vision to simplify government procurement.' },
    { year: '2016', title: 'GeM Expertise', desc: 'Became one of the first consultancies to specialise in Government e-Marketplace services.' },
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12">
          <motion.div className="max-w-2xl" {...fadeUp} transition={{ duration: 0.5 }}>
            ...
            <p className="text-lg text-gray-500 leading-relaxed mb-8">
              Empowering businesses to unlock government procurement opportunities since 2014 — with expertise, transparency, and a genuine commitment to your growth.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <div className="space-y-7">
                {[
                  { icon: <MapPin size={18} />, label: 'Address', lines: ['Phoenix Tender Tech Pvt. Ltd.', '123 Business Center, SG Highway', 'Ahmedabad, Gujarat 380015'] },
