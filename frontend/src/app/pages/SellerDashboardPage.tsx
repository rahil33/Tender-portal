...
import {
  ...
  ArrowRight, Package, BarChart2, FileText,
} from 'lucide-react';

type TenderStatus = 'approved' | 'pending' | 'under_review' | 'rejected' | 'sold';
...
export default function SellerDashboardPage() {
  ...
  const filtered = filter === 'all' ? mockTenders : mockTenders.filter((t) => t.status === filter);
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-500">
                          <span>Uploaded: {tender.uploadedDate}</span>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <div className="text-xl font-bold text-gray-900">{tender.price}</div>
                          <div className="text-xs text-gray-500">Listing Value</div>
                        </div>
                        <div className="flex gap-2">
                          <button className="w-9 h-9 rounded-xl flex items-center justify-center transition-all bg-gray-50 border border-gray-200 text-gray-700 hover:bg-gray-100" title="View Details">
                            <Eye size={16} />
                          </button>
